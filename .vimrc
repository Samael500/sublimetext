...
" Plugin 'Lokaltog/powerline', {'rtp': 'powerline/bindings/vim/'} " Powerline is a status bar that displays things like the current virtualenv, git branch, files being edited, and much more.
Plugin 'fisadev/FixedTaskList.vim'      " Pending tasks list
Plugin 'rosenfeld/conque-term'          " Consoles as buffers
Plugin 'tpope/vim-surround'             " Parentheses, brackets, quotes, XML tags, and more
Plugin 'severin-lemaignan/vim-minimap'
Plugin 'wakatime/vim-wakatime'          " WakaTime tracker
...
augroup vimrc_autocmds
    ...
    autocmd FileType ruby,python,javascript,c,cpp match Excess /\%119v.*/
